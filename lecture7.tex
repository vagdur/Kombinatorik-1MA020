...
\noindent Från våra studier av binomialkoefficienter vet vi att binomialtal går att skriva på flera olika (men ekvivalenta) vis. \sidenote[][]{Ett exempel ni kanske minns från föreläsning 2 är Pascals identitet.}
...
\par\bigskip
\begin{example}
  Kombinatoriken är även användbar inom andra områden i matematiken, även de mer abstrakta! Exempelvis finns en sak inom representationsteori som heter \textit{Young Tableaux} som räknar irreducibla representationer av symmtrigrupper. De ser ut på följande vis: 
    \begin{figure}
        \centering
        \includegraphics[width = 0.5\textwidth]{graphics/1200px-Young_tableaux_for_541_partition.svg.png}
        \caption{Fallet med hexagoner.}
    \end{figure}
    \par\bigskip
    \noindent De påminner nästan om Dyckstigar, och det visar sig att det finns vissa bijektioner som kan göras mellan de genom att exempelvis betrakta bergstoppar som de övre talen i tableaux:en och därmed säga saker om grupper. Coolt va! 
\end{example}
...
\begin{ans}
  ...
  \begin{figure}[h]
        \centering
        \includegraphics{initaltgrafsystem.png}
  \end{figure}
  \par\bigskip
  \noindent Om vi roterar planet med $45°$ grader får vi:
  \begin{figure}[h]
        \centering
        \includegraphics{roteratgrafsystem.png}
  \end{figure}
  \par\bigskip
