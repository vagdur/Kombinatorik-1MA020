...
Låt oss börja med att ge en hög med definitioner, som kommer vara väldigt bekanta för de av er som läst en kurs i grafteori innan.\sidenote[][]{Vilket som jag förstått det är ungefär en tredjedel av er -- så för resten behövs definitionerna.}
