...
Ordinarie tentamen för kursen inträffar den 20 mars -- kom ihåg att registrera er för den minst tolv dagar i förväg, alltså lördagen den 8 mars, det är inte kul att inte få skriva tentan för att man glömt registrera sig.\sidenote{Det hände mig mer än en gång under min kandidat och master...} Det går att få max fyrtio poäng på tentan, och för att få betyget 5a, 4a, 3a behövs respektive 32/25/18 poäng.
...
\begin{enumerate}
	...
	\item För uppgifterna eller programmeringsuppgiften är deadline två veckor efter övningstillfället faktiskt hölls, förutom om man väljer det sista övningstillfället, i vilket fall deadline är onsdagen den femte mars.\sidenote[][]{Detta är för att övningstillfället faller så sent i kursen -- er uppgift måste presenteras muntligen redan den tionde mars, och jag behöver tid att faktiskt läsa igenom ert arbete innan ni presenterar det.}
...
För den övriga delen av kursen och inlämningsuppgifterna får ni lov att använda AI för delar, men om ni försöker att bara mata in texten på uppgiften och sedan lämna in vad den matar ut får ni inte godkänt på det. Det kommer dessutom att skada er när ni skall försöka klara tentan -- och AIn är inte riktigt så smart att det hade funkat oavsett.\sidenote[][]{I mina ovetenskapliga test verkar den kunna hitta en korrekt lösning ibland, men också ibland i ett lika korrekt språkbruk skriva nonsens, eller saker som är subtilt fel på ett sätt som nog är svårt för dig som student att upptäcka.} Kort och gott, var smarta med hur ni använder det -- lämpa inte bara över allt ert eget tänkande på maskinen, för det kommer inte att fungera.
