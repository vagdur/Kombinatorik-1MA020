...
3            & Tis 24 Jan, 13:15 & F3: Gitterstigar och heltalspartitioner\\
4            & Tor 26 Jan, 08:15 & Övning/komma ikapp\\
5	      & Tis 31 Jan, 13:15 & F4: Induktion samt inklusion-exklusion\\
6            & Ons 1 Feb, 08:15 & F5: Fortsättning på inklusion-exklusion\\
...
14           & Tor 2 Mar, 10:15  & F11: Diskret sannolikhetsteori, fortsättning (Också näst sista dag att registrera sig för tentan)\\
...
Vilken grupp skall respondera på vilka? Det anges i nedanstående tabell.\sidenote[][]{Kom ihåg att deadline för själva uppgiften är två veckor efter föreläsningen inträffade, och deadline för kamratrespons är en vecka efter att era kamrater lämnat in. Så räkna framåt tre veckor från datumet i tabellen för att få deadline för er respons.}
...
\begin{table}[h]
	...
	Grupp 3            & Tis 24 Jan & Ingen, ännu\\
	Grupp 4            & Tis 31 Jan & 1\\
	Grupp 5	      	 & Ons 1 Feb & 5\\
	%Grupp 6            & Ons 2 Feb & F5: Fortsättning på inklusion-exklusion\\
	Grupp 7            & Tis 14 Feb  & 3\\
	%Grupp 8            & Tor 9 Feb  & Övning/komma ikapp\\
	%Grupp 9            & Tis 14 Feb & F7: Genererande funktioner\\
	Grupp 10            & Tor 28 Feb & 4%\\
	%Grupp 11            & Tis 21 Feb & F9: Fler exempel\\
	\end{tabularx}
\end{table}

Eftersom det är ett udda antal grupper blir en grupp utan kamratrespons. Just nu är det färre grupper än föreläsningar, men om vi i slutändan får ett fulltaligt antal grupper så kommer det vara grupp elva som inte får en respons, så att ingen behöver både tänka på att kamratrespondera och tentaplugga samtidigt.
...
\begin{itemize}
	...
	\item Ni kan skapa er en lokal kopia av filerna på GitHub genom att göra en clone av repositoryt, och sedan redigera filerna i en TeX-editor på er dator. Själv använder jag GitHub Desktop\sidenote{\url{https://desktop.github.com/}} för att hantera git-biten, och redigerar TeX-filerna i TeXworks eller Visual Studio Code\sidenote{TeXworks finns på \url{https://sourceforge.net/projects/texworks.mirror/} och VS Code på \url{https://code.visualstudio.com/}. VS Code är antagligen lite overkill om man inte redan har det installerat, men till skillnad från TeXworks har det en del autocomplete och annat man kanske är van vid från Overleaf eller programmering.}. Denna lösningen kräver, som ni förstår, mer mjukvara på er dator, och lite mer förståelse för hur git fungerar\sidenote{Med en lokal kopia räcker det inte att bara trycka commit, man måste också push-a sin commit till versionen på GitHub.}, men när man väl har fått den i ordning slipper man både väntetiden för att se effekten av sina förändringar (eftersom man kan kompilera filen lokalt på sin egna dator) och krånglet med att kopiera fram och tillbaka från Overleaf, som de andra metoderna led av.
\end{itemize}
