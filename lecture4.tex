...
\begin{proposition}
  ...
  $$\stirlingCycle{n}{n-3} = \frac{1}{6} (n - 2) (n - 1) n (n^3 - 31 n + 66).$$
  ...
  \begin{proof}
    ...
    \begin{enumerate}
      ...
      \begin{enumerate}
        \item välja vilka två personer som får sitta vid bordet med tre, vilket kan göras på $\binom{3}{2} = 6$ sätt,
    ...
    \begin{align*}
      \stirlingCycle{n}{n-3} &= \binom{n}{n-3}\left((n-3)(n-4)(n-5) + 12(n-3)(n-4) + 6(n-3)\right)\\
      &= \frac{1}{6} (n - 2) (n - 1) n (n^3 - 31 n + 66)
    \end{align*}
    såsom önskat.
  \end{proof}
\end{proposition}
